var Layout = function () {
    ...
    var handleSubMenuExt = function () {
        $(".header-navigation .dropdown").on("hover", function () {
            if ($(this).children(".header-navigation-content-ext").show()) {
                if ($(".header-navigation-content-ext").height() >= $(
                        ".header-navigation-description").height()) {
                    $(".header-navigation-description").css("height", $(
    ...
    var handleAccordions = function () {
        ...
        jQuery('body').on('shown.bs.collapse', '.accordion.scrollable',
            function (e) {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style-color').attr("href", contextPath
                + "/v2/assets/corporate/css/themes/" + color + ".css");
            $('.corporate .site-logo img').attr("src", contextPath
                + "/v2/assets/corporate/img/logos/logo-corp-" + color + ".png");
            $('.ecommerce .site-logo img').attr("src", contextPath
                + "/v2/assets/corporate/img/logos/logo-shop-" + color + ".png");
        }
    ...
    return {
        ...
        initTouchspin: function () {
            $(".product-quantity .form-controller").TouchSpin({
