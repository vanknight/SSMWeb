    ...
    $.fn.TouchSpin = function (options) {
        ...
        return this.each(function () {
            ...
            function _buildHtml() {
                ...
                originalinput.addClass('form-controller');
            ...
            function _advanceInputGroup(parentelement) {
                ...
                var downhtml,
                    ...
                    prefixhtml = '<span class="input-group-addon bootstrap-touchspin-prefix">'
                        + settings.prefix + '</span>',
                    postfixhtml = '<span class="input-group-addon bootstrap-touchspin-postfix">'
                        + settings.postfix + '</span>';

                if (prev.hasClass('input-group-btn')) {
                    downhtml = '<button class="' + settings.buttondown_class
                ...
                if (next.hasClass('input-group-btn')) {
                    uphtml = '<button class="' + settings.buttonup_class
            ...
            function _buildInputGroup() {
                ...
                if (settings.verticalbuttons) {
                    html = '<div class="input-group bootstrap-touchspin"><span class="input-group-addon bootstrap-touchspin-prefix">'
                        + settings.prefix
                    ...
                    html = '<div class="input-group bootstrap-touchspin"><span class="input-group-btn"><button class="'
                        + settings.buttondown_class
                        + ' bootstrap-touchspin-down" type="button">'
                        ...
                        + settings.buttonup_class
                        + ' bootstrap-touchspin-up" type="button">'
                        + settings.buttonup_txt + '</button></span></div>';
                }
            ...
            function _bindEvents() {
                ...
                $(document).on(
                    _scopeEventNames(['mouseup', 'touchend', 'touchcancel'],
            ...
            function _getBoostedStep() {
                if (!settings.booster) {
                    ...
                    var boosted = Math.pow(2,
                        Math.floor(spincount / settings.boostat))
                        * settings.step;
