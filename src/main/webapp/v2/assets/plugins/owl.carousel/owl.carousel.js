...
;(function ($, window, document, undefined) {
    ...
    Owl.Pipe = [{
        ...
        run: function (cache) {
            cache.current = this._items && this._items[this.relative(
                this._current)];
        }
    }, {
        ...
        run: function () {
            var i, n,
                clones = this._clones,
                items = this._items,
                delta = this.settings.loop ? clones.length
                    - Math.max(this.settings.items * 2, 4) : 0;

            for (i = 0, n = Math.abs(delta / 2); i < n; i++) {
                if (delta > 0) {
                    this.$stage.children().eq(items.length + clones.length
                        - 1).remove();
                    clones.pop();
                    ...
                    this.$stage.append(
                        items[clones[clones.length - 1]].clone().addClass(
                            'cloned'));
        ...
        run: function () {
            ...
            for (i = 0, n = this._coordinates.length; i < n; i++) {
                ...
                if ((this.op(inner, '<=', begin) && (this.op(inner, '>', end)))
                    || (this.op(outer, '<', begin) && this.op(outer, '>',
                        end))) {
                    matches.push(i);
                }
            }
            ...
            if (this.settings.center) {
                this.$stage.children('.'
                    + this.settings.centerClass).removeClass(
    ...
    Owl.prototype.initialize = function () {
        ...
        // attach custom controller events
    ...
    Owl.prototype.update = function () {
        ...
        while (i < n) {
            if (this._invalidated.all || $.grep(this._pipe[i].filter,
                    filter).length > 0) {
    ...
    Owl.prototype.onDragMove = function (event) {
        ...
        if (this.settings.loop) {
            if (this.op(this.drag.currentX, '>',
                    this.coordinates(this.minimum())) && this.state.direction
                === 'right') {
                this.drag.currentX -= (this.settings.center && this.coordinates(
                    0)) - this.coordinates(this._items.length);
            } else if (this.op(this.drag.currentX, '<',
                    this.coordinates(this.maximum())) && this.state.direction
                === 'left') {
                this.drag.currentX += (this.settings.center && this.coordinates(
                    0)) - this.coordinates(this._items.length);
            }
            ...
            this.drag.currentX = Math.max(
                Math.min(this.drag.currentX, minValue + pull), maxValue + pull);
        }
    ...
    Owl.prototype.onDragEnd = function (event) {
        ...
        // to border
        if (!this.settings.pullDrag && this.drag.updatedX === this.coordinates(
                closest)) {
            this.transitionEnd();
        }
    ...
    Owl.prototype.getTransformProperty = function () {
        ...
        transform = window.getComputedStyle(this.$stage.get(0),
            null).getPropertyValue(this.vendorName + 'transform');
    ...
    Owl.prototype.closest = function (coordinate) {
        var position = -1, pull = 30, width = this.width(),
        ...
        if (!this.settings.freeDrag) {
            ...
            $.each(coordinates, $.proxy(function (index, value) {
                if (coordinate > value - pull && coordinate < value + pull) {
                    ...
                    && this.op(coordinate, '>', coordinates[index + 1] || value
                        - width)) {
    ...
    Owl.prototype.animate = function (coordinate) {
        ...
        if (this.support3d) {
            ...
            this.$stage.animate({
                    left: coordinate
                }, this.speed() / 1000, this.settings.fallbackEasing,
                $.proxy(function () {
    ...
    Owl.prototype.normalize = function (position, relative) {
        ...
        if (this._clones.length) {
            ...
            position = Math.max(this.minimum(relative),
    ...
    Owl.prototype.coordinates = function (position) {
        ...
        if (this.settings.center) {
            ...
            coordinate += (this.width() - coordinate
                + (this._coordinates[position - 1] || 0)) / 2
    ...
    Owl.prototype.to = function (position, speed) {
        if (this.settings.loop) {
            ...
            if (after < this.settings.items && direction === false) {
                ...
                this.reset(revert);
            } else if (after >= items - this.settings.items && direction
                === true) {
                revert = before - this._items.length;
                this.reset(revert);
            }
    ...
    Owl.prototype.replace = function (content) {
        ...
        this.reset($.isNumeric(this.settings.startPosition)
    ...
    Owl.prototype.add = function (content, position) {
        ...
        if (this._items.length === 0 || position === this._items.length) {
            ...
            this._mergers.splice(position, 0, content.find(
                '[data-merge]').andSelf('[data-merge]').attr('data-merge') * 1
                || 1);
        }
    ...
    Owl.prototype.addTriggerableEvents = function () {
        ...
        $.each({
            ...
            this.$element.on(event + '.owl.carousel',
    ...
    function isTransform() {
        return isStyleSupported(
            ['transform', 'WebkitTransform', 'MozTransform', 'OTransform',
                'msTransform'])[0];
    }
    ...
    function isPerspective() {
        return isStyleSupported(
            ['perspective', 'webkitPerspective', 'MozPerspective',
                ...
                function (e) {
                    ...
                    if ((e.property && e.property.name == 'position') || e.type
                        ...
                        var settings = this._core.settings,
                            n = (settings.center && Math.ceil(settings.items
                                / 2) || settings.items),
                        ...
                        while (i++ < n) {
                            this.load(clones / 2 + this._core.relative(
                                position));
...
;(function ($, window, document, undefined) {
    ...
    Navigation.prototype.draw = function () {
        ...
        if (options.nav && !options.loop && !options.navRewind) {
            ...
            this._controls.$next.toggleClass('disabled', index
                >= this._core.maximum());
        }
        ...
        if (options.dots) {
            ...
            if (options.dotData && difference !== 0) {
                for (i = 0; i < this._controls.$indicators.children().length;
                    i++) {
                ...
                this._controls.$indicators.children().slice(
                    difference).remove();
            }
