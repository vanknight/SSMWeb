...
Previously, calls to update() would render all elements with the most recent set of options.  This has been fixed, but may change how your page looks.  SpringJunit4Test to make sure things still render as expected.
