    ...
    jQuery.fn.extend({
        slimScroll: function (options) {
            ...
            this.each(function () {
                ...
                o.height = (options.height == 'auto') ? me.parent().height()
                    : options.height;
                ...
                if ('ontouchstart' in window
                    ...
                    me.bind('MSPointerMove', function (e) {
                        ...
                        var diff = (touchDif - e.originalEvent.pageY)
                            / o.touchScrollStep;
                        // scroll content
                ...
                function _onWheel(e) {
                    ...
                    if ($(target).closest('.' + o.wrapperClass).is(
                            me.parent())) {
                        // scroll content
                ...
                function scrollContent(y, isWheel, isJump) {
                    ...
                    if (isWheel) {
                        ...
                        delta = parseInt(bar.css('top')) + y * parseInt(
                            o.wheelStep) / 100 * bar.outerHeight();
                    ...
                    percentScroll = parseInt(bar.css('top')) / (me.outerHeight()
                        - bar.outerHeight());
                    delta = percentScroll * (me[0].scrollHeight
                        - me.outerHeight());

                    if (isJump) {
                        delta = y;
                        var offsetTop = delta / me[0].scrollHeight
                            * me.outerHeight();
                ...
                function attachWheel() {
                    if (window.addEventListener) {
                        this.addEventListener('DOMMouseScroll', _onWheel,
                            false);
