...
(function ($, undefined) {
    ...
    $.each({show: "fadeIn", hide: "fadeOut"}, function (method, defaultEffect) {
        $.Widget.prototype["_" + method] = function (element, options,
            ...
            var hasOptions,
                effectName = !options ? method : options === true
                || typeof options === "number" ? defaultEffect : options.effect
                    || defaultEffect;
            options = options || {};
...
(function ($, undefined) {
    ...
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _mouseStop: function (event) {
            ...
            if (this.options.helper === "original" && !$.contains(
            ...
            if ((this.options.revert === "invalid" && !dropped)
                ...
                || this.options.revert === true || ($.isFunction(
                    this.options.revert) && this.options.revert.call(
        ...
        _createHelper: function (event) {
            ...
            var o = this.options,
                helper = $.isFunction(o.helper) ? $(
                    o.helper.apply(this.element[0], [event])) : (o.helper
                === "clone" ? this.element.clone().removeAttr("id")
                    : this.element);

            if (!helper.parents("body").length) {
                helper.appendTo(
                    (o.appendTo === "parent" ? this.element[0].parentNode
                        : o.appendTo));
            }
        ...
        _setContainment: function () {
            ...
            this.containment = [
                ...
                ( over ? Math.max(ce.scrollWidth, ce.offsetWidth)
                    : ce.offsetWidth ) - ( parseInt(c.css("borderRightWidth"),
                    10) || 0 ) - ( parseInt(c.css("paddingRight"), 10) || 0 )
                - this.helperProportions.width - this.margins.left
                - this.margins.right,
                ( over ? Math.max(ce.scrollHeight, ce.offsetHeight)
                    : ce.offsetHeight ) - ( parseInt(c.css("borderBottomWidth"),
                    10) || 0 ) - ( parseInt(c.css("paddingBottom"), 10) || 0 )
                - this.helperProportions.height - this.margins.top
                - this.margins.bottom
            ];
            ...
            if (this.originalPosition) {
                ...
                if (o.grid) {
                    ...
                    pageY = containment ? ((top - this.offset.click.top
                        ...
                        >= containment[1]) ? top - o.grid[1] : top + o.grid[1]))
                        : top;
                    ...
                    pageX = containment ? ((left - this.offset.click.left
                        ...
                        > containment[2]) ? left : ((left
                        - this.offset.click.left >= containment[0]) ? left
                        - o.grid[0] : left + o.grid[0])) : left;
                }
    ...
    $.ui.plugin.add("draggable", "connectToSortable", {
        ...
        drag: function (event, ui) {
            ...
            $.each(inst.sortables, function () {
                ...
                if (this.instance._intersectsWith(
        ...
        prepareOffsets: function (t, event) {
            ...
            droppablesLoop: for (i = 0; i < m.length; i++) {
                ...
                if (m[i].options.disabled || (t && !m[i].accept.call(
                        m[i].element[0], (t.currentItem || t.element)))) {
                    continue;
                }
    ...
    $.widget("ui.resizable", $.ui.mouse, {
        ...
        _mouseStart: function (event) {
            ...
            if ((/absolute/).test(el.css("position"))) {
                ...
                el.css(
                    {position: "absolute", top: iniPos.top, left: iniPos.left});
            }
            ...
            this.aspectRatio = (typeof o.aspectRatio === "number")
                ? o.aspectRatio : ((this.originalSize.width
 ...
 */
    ...
    $.ui.plugin.add("resizable", "containment", {
        ...
        resize: function (event) {
            ...
            if (cp.left < (that._helper ? co.left : 0)) {
                that.size.width = that.size.width + (that._helper
                    ? (that.position.left - co.left) : (that.position.left
                        - cop.left));
                if (pRatio) {
        ...
        stop: function () {
            ...
            if (that._helper && !o.animate && (/relative/).test(
                    ce.css("position"))) {
                $(this).css(
                    {left: ho.left - cop.left - co.left, width: w, height: h});
            }

            if (that._helper && !o.animate && (/static/).test(
                    ce.css("position"))) {
                $(this).css(
                    {left: ho.left - cop.left - co.left, width: w, height: h});
            }
                    ...
                    $(exp).each(function () {
                        var el = $(this),
                            ...
                            css = c && c.length ? c : el.parents(
                                ui.originalElement[0]).length ? ["width",
...
(function ($, undefined) {
    ...
    $.widget("ui.sortable", $.ui.mouse, {
        ...
        _create: function () {
            ...
            this.floating = this.items.length ? o.axis === "x" || isFloating(
                this.items[0].item) : false;
            ...
            if (this.options.scroll) {
                if (this.scrollParent[0] !== document
                    ...
                    if ((this.overflowOffset.top
                            + this.scrollParent[0].offsetHeight) - event.pageY
                        < o.scrollSensitivity) {
                    ...
                    if ((this.overflowOffset.left
                            + this.scrollParent[0].offsetWidth) - event.pageX
                        < o.scrollSensitivity) {
            ...
            if (this.options.revert) {
                ...
                if (!axis || axis === "y") {
                    animation.top = cur.top - this.offset.parent.top
                        - this.margins.top + (this.offsetParent[0]
        ...
        _intersectsWithPointer: function (item) {
            ...
            return this.floating ? ( ((horizontalDirection
                && horizontalDirection === "right") || verticalDirection
                === "down") ? 2 : 1 )
        ...
        _contactContainers: function (event) {
            ...
            if (this.containers.length === 1) {
                ...
                floating = innermostContainer.floating || isFloating(
                    this.currentItem);
                ...
                for (j = this.items.length - 1; j >= 0; j--) {
                    ...
                    if (floating && !isOverAxis(this.positionAbs.top
                            + this.offset.click.top, this.items[j].top,
                            this.items[j].height)) {
                        continue;
                    }
            ...
            if (!(/^(document|window|parent)$/).test(o.containment)) {
                ...
                this.containment = [
                    ...
                    co.left + (over ? Math.max(ce.scrollWidth, ce.offsetWidth)
                        ...
                        $(ce).css("borderLeftWidth"), 10) || 0) - (parseInt(
                        $(ce).css("paddingRight"), 10) || 0)
                    - this.helperProportions.width - this.margins.left,
                    co.top + (over ? Math.max(ce.scrollHeight, ce.offsetHeight)
                        : ce.offsetHeight) - (parseInt(
                        $(ce).css("borderTopWidth"), 10) || 0) - (parseInt(
        ...
        color.fn = jQuery.extend(color.prototype, {
            ...
            is: function (compare) {
                ...
                each(spaces, function (_, space) {
                    ...
                    if (isCache) {
                        localCache = inst[space.cache] || space.to && space.to(
                            inst._rgba) || [];
            ...
            each(props, function (key, prop) {
                ...
                color.fn[key] = function (value) {
                    ...
                    if (vtype === "string") {
                        ...
                        if (match) {
                            value = cur + parseFloat(match[2]) * ( match[1]
                            === "+" ? 1 : -1 );
                        }
                    }
...
// based on easing equations from Robert Penner (http://www.robertpenner.com/easing)
        ...
        $.extend(baseEasings, {
            ...
            Bounce: function (p) {
                ...
                return 1 / Math.pow(4, 3 - bounce) - 7.5625 * Math.pow(( pow2
                    * 3 - 2 ) / 22 - p, 2);
            }
        });
...
// used to prevent race conditions with remote data sources
    ...
    $.widget("ui.autocomplete", {
            ...
            this._on(this.menu.element, {
                ...
                menufocus: function (event, ui) {
                    ...
                    if (false !== this._trigger("focus", event, {item: item})) {
                        ...
                        if (event.originalEvent && /^key/.test(
                                event.originalEvent.type)) {
        ...
        _renderItemData: function (ul, item) {
            return this._renderItem(ul, item).data("ui-autocomplete-item",
                item);
        },
...
(function ($, undefined) {
   ...
   allowing multiple different settings on the same page. */
	 ...
	 */
        ...
        _connectDatepicker: function (target, inst) {
            ...
            input.addClass(this.markerClassName).keydown(
                this._doKeyDown).keypress(this._doKeyPress).keyup(
                this._doKeyUp);
            this._autoSize(inst);
	 ...
	 */
        ...
        /* Detach a datepicker from its controller.
	 * @param  target	element - the target input field or division or span
	 */
	 ...
	 */
        ...
        /* Retrieve the instance data for the target controller.
	 * @param  target  element - the target input field or division or span
        ...
        _optionDatepicker: function (target, name, value) {
            ...
            if (arguments.length === 2 && typeof name === "string") {
                return (name === "defaults" ? $.extend({},
                    $.datepicker._defaults) : (inst ? (name === "all"
                    ? $.extend({}, inst.settings) : this._get(inst, name))
                    : null));
            }
	 ...
	 */
        _showDatepicker: function (input) {
            ...
            inst.dpDiv.css({
                position: ($.datepicker._inDialog && $.blockUI ? "static"
                    : (isFixed ? "fixed" : "absolute")), display: "none",
        ...
        _updateDatepicker: function (inst) {
            ...
            inst.dpDiv.removeClass(
                ...
                "");
            if (cols > 1) {
                inst.dpDiv.addClass("ui-datepicker-multi-" + cols).css(
                    "width", (width * cols) + "em");
            }
        ...
        _checkOffset: function (inst, offset, isFixed) {
            var dpWidth = inst.dpDiv.outerWidth(),
                ...
                viewWidth = document.documentElement.clientWidth + (isFixed ? 0
                    : $(document).scrollLeft()),
                viewHeight = document.documentElement.clientHeight + (isFixed
        ...
        parseDate: function (format, value, settings) {
            ...
            var iFormat, dim, extra,
                ...
                shortYearCutoff = (typeof shortYearCutoffTemp !== "string"
                    ? shortYearCutoffTemp : new Date().getFullYear() % 100
                            ...
                            case "o":
                                output += formatNumber("o",
                                    Math.round((new Date(date.getFullYear(),
                                        date.getMonth(),
                                        date.getDate()).getTime() - new Date(
                                        date.getFullYear(), 0, 0).getTime())
                                        / 86400000), 3);
                                break;
                            case "m":
	 ...
	 */
        ...
        _getDate: function (inst) {
            var startDate = (!inst.currentYear || (inst.input
                && inst.input.val() === "") ? null : this._daylightSavingAdjust(
                new Date(
	 ...
	 */
                ...
                if (secondary || !changeYear) {
                    ...
                    determineYear = function (value) {
                        var year = (value.match(/c[+\-].*/) ? drawYear
                            + parseInt(value.substring(1), 10) : (value.match(
        ...
        _getFormatConfig: function (inst) {
            ...
            shortYearCutoff = (typeof shortYearCutoff !== "string"
                ? shortYearCutoff : new Date().getFullYear() % 100 + parseInt(
                shortYearCutoff, 10));
            return {
    ...
    function bindHover(dpDiv) {
        ...
        .delegate(selector, "mouseover", function () {
            if (!$.datepicker._isDisabledDatepicker(
                    instActive.inline ? dpDiv.parent()[0]
                        : instActive.input[0])) {
...
(function ($, undefined) {
    ...
    function getOffsets(offsets, width, height) {
        return [
            parseFloat(offsets[0]) * ( rpercent.test(offsets[0]) ? width / 100
                : 1 ),
            parseFloat(offsets[1]) * ( rpercent.test(offsets[1]) ? height / 100
                : 1 )
        ];
    }
            ...
            top: function (position, data) {
                ...
                if (overTop < 0) {
                    ...
                    if (( position.top + myOffset + atOffset + offset) > overTop
                        && ( newOverBottom < 0 || newOverBottom < abs(
                            overTop) )) {
                    ...
                    if (( position.top + myOffset + atOffset + offset)
                        > overBottom && ( newOverTop > 0 || abs(newOverTop)
                            < overBottom )) {
                        position.top += myOffset + atOffset + offset;
                    }
                }
            ...
            this.handles.each(function (i) {
                ...
                if (( distance > thisDistance ) ||
                    ( distance === thisDistance &&
                        (i === that._lastChangedValue || that.values(i)
                            === o.min ))) {
                    distance = thisDistance;
                    closestHandle = $(this);
                    index = i;
...
(function ($) {
    ...
    $.widget("ui.spinner", {
        ...
        _increment: function (i) {
            ...
            if (incremental) {
                return $.isFunction(incremental) ? incremental(i) : Math.floor(i
                    * i * i / 50000 - i * i / 500 + 17 * i / 200 + 1);
            }
...
(function ($, undefined) {
    ...
    $.widget("ui.tabs", {
        ...
        _tabKeydown: function (event) {
            ...
            // Navigating with controller key will prevent automatic activation
            if (!event.ctrlKey) {
        ...
        refresh: function () {
            ...
            if (options.active === false || !this.anchors.length) {
                ...
                if (this.tabs.length === options.disabled.length) {
                    ...
                    this._activate(
                        this._findNextTab(Math.max(0, options.active - 1),
                            false));
                }
